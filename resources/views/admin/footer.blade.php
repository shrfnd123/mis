    ...
    $('.editUser').click(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                document.getElementById("street_address").value = response.streest_address;
                document.getElementById("city").value = response.city;
                document.getElementById("contact_num").value = response.contact_num;
