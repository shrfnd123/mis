        ...
        <div class="row justify-content-center">
          <div class="col-xl-10 ftco-animate">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
		            	<div class="form-group">
	                  <input type="text" class="form-control" placeholder="Appartment, suite, unit etc: (optional)" name="street1">
	                </div>
		            </div>
		            <div class="w-100"></div>
		            <div class="col-md-6">
                ...
                <div>
                        ...
                        <p><button type="submit" class="btn btn-primary py-3 px-4" width="50%;">Register</button></p>			
