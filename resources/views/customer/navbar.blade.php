<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{ route('index') }}">Tireshop</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                @if (session('logged') == true)
                    <li class="nav-item active"><a href="{{ route('Recommender') }}" class="nav-link">What's Hot</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown"
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdown04">
                            ...
                            <a class="dropdown-item" href="{{ route('historyView') }}">History</a>
                ...
                @endif
                <li class="nav-item cta cta-colored"><a href="{{ route('CartPreview') }}" class="nav-link"><span
                            class="icon-shopping_cart"></span>[@if (empty(session('order')))0 @else{{ count(session('order')) }}@endif]</a></li>
